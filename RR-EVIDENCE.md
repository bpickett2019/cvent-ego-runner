...
Fresh CLI invocations load this helper. The native-Pi launcher change requires an authorized app restart; new jobs then capture the standing scope and short task separately. Historical scopes, workbooks, receipts and cumulative costs are not reset. A 90-minute end-to-end completion target remains unproven; no automatic 90-minute deadline or new remote bulk-job execution has been introduced.
